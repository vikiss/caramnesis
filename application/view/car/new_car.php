  ...
  <div class="clearfix">
    ...
    <h2><?= _("NEWCAR_ADD"); ?></h2>
          ...
          <div class="lblgrp"><label for="car_year"><?= _("NEWCAR_YEAR"); ?></label>
                ...
                <div id="nwmodeldialog" class="center" title="<?= _("NEWCAR_MODEL"); ?>"><?php echo _("PICK_A_MAKE_AND_YEAR_FIRST"); ?></div>
          <div class="lblgrp"><label for="nwmodelopener"><?php echo _("NEWCAR_MODEL"); ?></label>
                ...
                <div id="nwvariantdialog" class="center" title="<?= _("NEWCAR_VARIANT"); ?>"><?php echo _("PICK_A_MAKE_AND_MODEL_FIRST"); ?></div>
