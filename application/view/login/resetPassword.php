<div class="container">
  <div class="clearfix">
    ...
    <h1><?php echo _("PWCHANGE_SET"); ?></h1>
            ...
            <label for="reset_input_password_new"><?php echo _("PWCHANGE_NEW_PWD"); ?></label>
            ...
            <label for="reset_input_password_repeat"><?php echo _("PWCHANGE_NEW_REPEAT"); ?></label>
            ...
            <input type="submit" class="btn btn-primary mb1 mt1 black bg-kcms" name="submit_new_password" value="<?php echo _("PWCHANGE_NEW_SUBMIT"); ?>" />
        </form>
         <a href="<?php echo Config::get('URL'); ?>login/index"><?php echo _("PWCHANGE_BACK_TO_LOGIN"); ?></a>
        </div>
      </div>
    </div>
</div>