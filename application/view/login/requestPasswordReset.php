<div class="container">
  <div class="clearfix">
    ...
    <h1><?php echo _("PWCHANGE_REQUEST"); ?></h1>
        <form method="post" action="<?php echo Config::get('URL'); ?>login/requestPasswordReset_action">
            <label>
                <?php echo _("PWCHANGE_ENTER_YOUR_DATA"); ?>
                <input type="text" name="user_name_or_email" class="block col-12 field mt1 " required />
            </label>
            <input type="submit" value="<?php echo _("PWCHANGE_SEND_IT_TO_ME"); ?>" class="btn btn-primary mb1 mt1 black bg-kcms" />
        </form>
        </div>
      </div>
    </div>
