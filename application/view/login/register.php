<div class="container">
  <div class="clearfix">
    ...
    <div class="right-align"><?php
    $languages = $this->languages;
    foreach ($languages AS $key => $language) {
      if ($key !== $this->current_language) {
        echo '<a class="smallish ml2" href="?lang='.$key.'">'.$this->language_names[$key].'</a>  ';
      } else {
				echo '<span class="smallish ml2">'.$this->language_names[$key].'</span> ';
			}
    }
    ?></div>
            ...
            <div class="block col-12 mt1 clearfix relative">
            <img class="left" id="captcha" src="<?php echo Config::get('URL'); ?>login/showCaptcha" />
            <a class="absolute bottom-0 right-0 smallish" href="#" onclick="document.getElementById('captcha').src = '<?php echo Config::get('URL'); ?>login/showCaptcha?' + Math.random(); return false"><?php echo _("REGISTER_RELOAD_CAPTCHA"); ?></a>
            </div>
